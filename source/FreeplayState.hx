...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		addWeek(['velma-style-whats-new'], 1, ['velma', 'bf', 'gf']);
		addWeek(['terror-time'], 1, ['velma', 'bf', 'gf']);
		addWeek(['jinkies'], 1, ['velmamad', 'bf', 'gf']);
		addWeek(['surface'], 1, ['velmagod', 'bf', 'gf']);
		addWeek(['velmas-spam-challenge'], 1, ['velmagod', 'bf', 'gf']);
		addWeek(['the-end'], 1, ['dad', 'bf', 'gf']);
		...
		scoreText = new FlxText(FlxG.width * 0.6, 5, 0, "", 32);
